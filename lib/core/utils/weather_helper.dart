...
class WeatherHelper {
  static String getWeatherIcon(int code) {
    String asset = AppAssetsImages.iconCloudPng;
    if (code >= 200 && code <= 299) {
      asset = AppAssetsImages.iconThunderPng;
    } else if (code >= 300 && code <= 399) {
      asset = AppAssetsImages.iconCloudLittleRainPng;
    } else if (code >= 500 && code <= 599) {
      asset = AppAssetsImages.iconRainPng;
    } else if (code >= 600 && code <= 699) {
      asset = AppAssetsImages.iconSnowPng;
    } else if (code >= 700 && code <= 799) {
      asset = AppAssetsImages.iconDustPng;
    } else if (code == 800) {
      asset = AppAssetsImages.iconSunPng;
    } else if (code == 801) {
      asset = AppAssetsImages.iconCloudSunPng;
    } else if (code >= 802) {
      asset = AppAssetsImages.iconCloudPng;
    }
    return asset;
  }
