...
class ChartData {
  ...
  List<Point> _getPoints(
    ...
    final double halfHeight = (height - 15) / 2;
  ...
  List<ChartLine> _getAxes(List<Point> points, List<DateTime> dateTimes,
    ...
    list.add(ChartLine(mainAxisText, Offset(-25, height / 2 - 15),
        Offset(-5, (height - 15) / 2), Offset(width + 5, (height - 15) / 2)));
    ...
    for (int index = 0; index < points.length; index++) {
      ...
      list.add(ChartLine(
          ...
          Offset(point.x.toDouble(), 0),
          Offset(point.x.toDouble(), height - 10)));
    }
    return list;
  }
